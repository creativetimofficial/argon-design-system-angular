  ...
  goSignup() {
    if (this.register.valid) {
      ...
      this.authenticationService.signup(body)
        .then(response => {
          if (response === 'true') {
            this.notificationService.showNotification(this.toolConstService.getSuccessMessage().userCreated, 'success');
          } else {
            this.notificationService.showNotification(this.toolConstService.getErrorMessages().userExist, 'danger');
          }
        });    
    } 
  }
